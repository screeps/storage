...
function upgradeDb() {
    ...
    if(envData.databaseVersion < 4.1) {
        console.log("Upgrading database to version 4.1");
        ...
        if(powerCreepsCollection) {
            ...
            powerCreeps.forEach(powerCreep => {
                console.log(`${powerCreep.type}#${powerCreep._id}`);
                converters[powerCreep.type](powerCreep);
